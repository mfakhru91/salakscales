...
!(function (a, b, c, d) {
  function e (b, c) {
    (this.element = b), (this.settings = a.extend (
      ...
      k,
      c
    )), (this._defaults = k), (this._name = j), this.init ();
  }
  function f (a) {
  ...
  (e.prototype = {
    init: function () {
      ...
      (b.template = {
        ...
        a (d).find ('tr').not (b.settings.exclude).each (function (c, d) {
          (e +=
            '<tr>'), a (d).find ('td,th').not (b.settings.exclude).each (function (c, d) {
            a (d).find (b.settings.exclude).length >= 1
              ? (e += '<td> </td>')
              : (e += '<td>' + a (d).html () + '</td>');
          }), (e += '</tr>');
        }), b.settings.exclude_img &&
          (e = g (
            e
          )), b.settings.exclude_links && (e = h (e)), b.settings.exclude_inputs && (e = i (e)), b.tableRows.push (e);
    ...
    tableToExcel: function (d, e, g) {
      ...
      if ((delete k.ctx.table, !c.documentMode)) {
        ...
        (b.URL = b.URL || b.webkitURL), (i = b.URL.createObjectURL (
          m
        )), (j = c.createElement ('a')), (j.download = f (
          k.settings
        )), (j.href = i), c.body.appendChild (
          j
        ), j.click (), c.body.removeChild (j);
        ...
        txtArea1.document.open (
          ...
          k.format (l, k.ctx)
        ), txtArea1.document.close (), txtArea1.focus (), (sa = txtArea1.document.execCommand (
          'SaveAs',
          !0,
          f (k.settings)
        ));
